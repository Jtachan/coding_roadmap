...
As a good practise, you should get familiarized with the [_Python General Docs_](https://docs.python.org/3/).
Here you will find all built-in modules and functions.

> Note: For these exercises is expected that you have Python 3.11 of higher.
...
- **Theory**: The needed theory to complete the exercise.
